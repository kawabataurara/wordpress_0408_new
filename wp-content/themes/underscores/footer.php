<footer class="footer_style">
			<div class="content_inner">
				<div class="footer__area">
					<div>
						<p class="footer__icon"><a href="<?php echo esc_url(home_url('/')); ?>index.php"><svg aria-label="株式会社LULL" class="is--loaded" viewbox="0 0 300 52" xmlns="http://www.w3.org/2000/svg">
						<g>
						...
						<div class="company__access">
							<p>株式会社LULL</p>
							<p>169-0072</p>
							<p>東京都新宿区大久保2丁目4-15サンライズ新宿4階</p>
							<p>TEL03-6457-3780</p>
							<p>MAILinfo@lull-inc.co.jp</p>
						</div>
					</div>
